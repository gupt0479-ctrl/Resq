...
const NODES: Node[] = [
  ...
  { id: "resq",label: "Resq",sub: ["Agent core"],                                          x: 310, y: 210, w: 150, h: 50, primary: true },
...
const EDGES: Edge[] = [
  { from: "tinyfish",  to: "resq", label: "fetch offers" },
  { from: "gmail",     to: "resq", label: "draft outreach" },
  { from: "vendor",    to: "resq", label: "compare pricing" },
  { from: "resq",  to: "stripe",   label: "inspect invoice state" },
  { from: "resq",  to: "insurance",label: "check renewal terms" },
]
